			...
			<div class="p-6">
				<div class="mb-6 flex overflow-x-auto border-b border-gray-200">
					<button
						...
						onclick={(evt) => openTab(evt, 'Module 1')}>Module 1</button
					>
					<button
						class="tab-btn px-6 py-3 font-medium text-gray-500 transition-colors hover:text-blue-600"
						onclick={(evt) => openTab(evt, 'Module 2')}>Module 2</button
					>
					<button
						class="tab-btn px-6 py-3 font-medium text-gray-500 transition-colors hover:text-blue-600"
						onclick={(evt) => openTab(evt, 'Module 3')}>Module 3</button
					>
					<button
						class="tab-btn px-6 py-3 font-medium text-gray-500 transition-colors hover:text-blue-600"
						onclick={(evt) => openTab(evt, 'Module 4')}>Module 4</button
					>
					<button
						class="tab-btn px-6 py-3 font-medium text-gray-500 transition-colors hover:text-blue-600"
						onclick={(evt) => openTab(evt, 'Module 5')}>Module 5</button
					>
				</div>
				...
				<div id="Module 5" class="tab-content">
